...
class Product_model extends Core_Model
{
	...
	public function filter_products($category_id)
	{
		...
		if ($search != "promoted_products" && $search != "product_for_sales" && $search != "top_products" && $search != "trending_products" && $search != "latest_products" && $search != "promoted_works" && $search != "top_works" && $search != "trending_works" && $search != "latest_works") {
			$this->db->group_start();

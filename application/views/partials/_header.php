										...
										<div class="left">
											<div class="dropdown search-select">
												...
												<div class="dropdown-menu">
													...
													<a class="dropdown-item" data-value="Handwork" href="javascript:void(0)"><?php echo("Handwork"); ?></a>
													<a class="dropdown-item" data-value="Store" href="javascript:void(0)"><?php echo("Store"); ?></a>
												</div>
											</div>
											<?php if (isset($search_type)): ?>
												<input type="hidden" class="search_type_input" name="search_type" value="<?php echo $search_type; ?>">
											<?php else: ?>
												<input type="hidden" class="search_type_input" name="search_type" value="product">
											<?php endif; ?>
										</div>
										<div class="right">
											<input type="text" name="search" maxlength="300" pattern=".*\S+.*" id="input_search" class="form-control input-search" value="<?php echo  (!empty($filter_search)) ? $filter_search : ''; ?>" placeholder="<?php echo ("Search for products, handworks or stores"); ?>" required autocomplete="off">
								...
								<ul class="nav align-items-center">
									...
									<?php if (auth_check()): ?>
										<li class="dropdown profile-dropdown">
											<a class="dropdown-toggle a-profile pad" data-toggle="dropdown" href="javascript:void(0)"
											   aria-expanded="false">
												...
												<span class="username"><?php $num_len = strlen($this->auth_user->username); if ($num_len > 11) {
                                            echo substr($this->auth_user->username, 0, 10) . "..";
												...
												<li>
													<a href="<?php echo lang_base_url(); ?>profile/<?php echo $this->auth_user->slug; ?>">
														<?php if (user()->role == "member" && user()->is_workshop == 1): ?>
															<i class="icon-price-tag-o"></i><?php echo (" Visit Workshop"); ?>
														<?php elseif (user()->role == "member" && user()->is_workshop == 0): ?>
															<i class="icon-user"></i><?php echo trans("view_profile"); ?>
														<?php else: ?><i class="icon-cart"></i><?php echo (" Visit Store"); ?><?php endif; ?>
													</a>
												</li>
												<?php if (is_sale_active()): ?>
													<li>
										...
										<?php if (is_multi_vendor_active()): ?>
											...
											<li class="nav-item"><a href="<?php echo lang_base_url(); ?>sell-now?pt=forsale" class="btn btn-md btn-custom btn-sell-now pad"><?php echo trans("sell_now"); ?></a></li>
											<?php else: ?>
											<li class="nav-item"><a href="<?php echo lang_base_url(); ?>sell-now" class="btn btn-md btn-custom btn-sell-now pad"><?php echo trans("sell_now"); ?></a></li>
											<?php endif; ?>
										<?php endif; ?>
									<?php else: ?>
										...
										<?php if (is_multi_vendor_active()): ?>
											<li class="nav-item"><a href="<?php echo lang_base_url(); ?>register" class="btn btn-md btn-custom btn-sell-now pad"><?php echo trans("sell_now"); ?></a></li>
										<?php endif; ?>
									<?php endif; ?>
								</ul>
									...
									<div class="region-right">
										<div class="row-custom footer-location">
											...
											<div class="icon-text">
												...
												<button type="button" class="btn btn-primary dropdown-toggle bn-lg" data-toggle="dropdown" style="min-width: 0px; min-height: 0px; text-align: left; width: unset;">
													<?php if ($num_len > 8) {echo substr($default_state, 0, 7) . "..";} else { echo $default_state;} ?><span class="icon-arrow-down"></span>
												</button>
												<button type="button" class="btn btn-primary dropdown-toggle bn-md" data-toggle="dropdown" style="font-size: 12px; min-width: 0px; min-height: 0px; text-align: left; width: unset;">
													<?php if ($num_len > 8) {echo substr($default_state, 0, 7) . "..";} else { echo $default_state;} ?><span class="icon-arrow-down"></span>
												</button>
												<div class="dropdown-menu">
							...
							<div class="top-search-bar mobile-search-form" style="margin: 0px; padding: 0px;">
								<?php echo form_open(lang_base_url() . 'search', ['id' => 'form_validate_search_mobile', 'method' => 'get']); ?>
									<div class="left" style="min-width: 10px;">
										<div class="dropdown search-select" style="min-width: 10px;">
											<button type="button" class="dropdown-toggle" data-toggle="dropdown" style="border-top-left-radius: 15px; border-bottom-left-radius: 15px; min-width: 10px;" id="button">
												<?php if (isset($search_type)): ?>
													<?php if ($search_type == 'Handwork'): ?>
														<i class="icon-shopping-bag" style="padding-right: 8px;"></i>
													<?php elseif($search_type == 'Store'): ?>
														<i class="icon-cart" style="padding-right: 8px;"></i>
													<?php elseif($search_type == 'product'): ?>
														<i class="icon-shopping-basket" style="padding-right: 8px;"></i>
													<?php endif; ?>
												<?php else: ?>
													<i class="icon-shopping-basket" style="padding-right: 8px;"></i>
												<?php endif; ?>
											...
											<div class="dropdown-menu">
												<a class="dropdown-item" data-value="product" href="javascript:void(0)" onclick="set_icon('product');"><i class="icon-shopping-basket"></i>&nbsp; <?php echo trans("product"); ?></a>
												<a class="dropdown-item" data-value="Handwork" href="javascript:void(0)" onclick="set_icon('handwork');"><i class="icon-shopping-bag"></i>&nbsp; <?php echo("Handwork"); ?></a>
												<a class="dropdown-item" data-value="Store" href="javascript:void(0)" onclick="set_icon('store');"><i class="icon-cart"></i>&nbsp; <?php echo("Store"); ?></a>
											</div>
										</div>
										<?php if (isset($search_type)): ?>
											<input type="hidden" class="search_type_input" name="search_type" value="<?php echo $search_type; ?>">
									...
									<div class="right">
										<input type="text" name="search" maxlength="300" pattern=".*\S+.*" id="input_search" class="form-control input-search" value="<?php echo  (!empty($filter_search)) ? $filter_search : ''; ?>" placeholder="<?php echo ("Search for products, handworks or stores"); ?>" required autocomplete="off" style="border-top-right-radius: 15px !important; border-bottom-right-radius: 15px !important;">
										<button class="btn btn-default btn-search"><i class="icon-search"></i></button>
										<div id="response_search_results" class="search-results-ajax"></div>
									</div>
								<?php echo form_close(); ?>

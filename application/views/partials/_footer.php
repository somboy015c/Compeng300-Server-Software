						...
						<div class="col-12 col-md-3 footer-widget">
							<div class="nav-footer">
									<?php if ($general_settings->default_product_location == 0): ?>
										<div class="row-custom">
											<h4 class="footer-title"><?php echo ("Shopping Location"); ?></h4>
										</div>
								...
								<div class="row-custom" style="margin-top: 10px;">
									<h4 class="footer-title"><?php echo ("Personal Location"); ?></h4>
								</div>
								<div class="row-custom">
									<ul>
										...
										<ul class="nav align-items-center">
											...
											<?php if (auth_check()): ?>
												<?php if (is_multi_vendor_active()): ?>
													...
													<li class="nav-item"><a href="<?php echo lang_base_url(); ?>sell-now?pt=forsale" class="btn btn-md btn-custom btn-sell-now" style="width: 46px; height: 46px; font-size: 25px; border-radius: 100%; padding: 7px 10px 5px 12px;"><i class="icon-plus"></i></a></li>
													<?php else: ?>
													<li class="nav-item"><a href="<?php echo lang_base_url(); ?>sell-now" class="btn btn-md btn-custom btn-sell-now" style="width: 46px; height: 46px; font-size: 25px; border-radius: 100%; padding: 7px 10px 5px 12px;"><i class="icon-plus"></i></a></li>
													<?php endif; ?>
												<?php endif; ?>
											<?php endif; ?>
										</ul>
								...
								<ul class="nav align-items-center">
									<li class="nav-item li-main-nav-right">
										<ul class="nav align-items-center">
											...
											<?php if (!auth_check()): ?>
												<?php if (is_multi_vendor_active()): ?>
													<li class="nav-item"><a href="<?php echo lang_base_url(); ?>register" class="btn btn-md btn-custom btn-sell-now" style="width: 46px; height: 46px; font-size: 25px; border-radius: 100%; padding: 7px 10px 5px 12px;"><i class="icon-plus"></i></a></li>
												<?php endif; ?>
											<?php endif; ?>
										</ul>
									</li>
												...
												<li class="dropdown profile-dropdown">
													...
													<ul class="dropdown-menu">
														<?php if (user()->role == "member"): ?>
															<li>
																<a href="<?php echo lang_base_url(); ?>pending-products">
																	<i class="icon-wallet"></i>&nbsp;<?php echo ("Post Advert"); ?>
																</a>
															</li>
														<?php else: ?>
															<li>
														...
														<?php if (!user()->is_member): ?>
															<li>
																<a href="<?php echo lang_base_url(); ?>start-selling">
																	<i class="icon-cart"></i>&nbsp;<?php echo ("Open a Shop"); ?>
																</a>
															</li>
															<li>
																<a href="<?php echo lang_base_url(); ?>start-selling?req=workshop">
																	<i class="icon-price-tag-o"></i>&nbsp;<?php echo ("Open a Workshop"); ?>
																</a>
															</li>
														<?php else: ?>
															<?php if (user()->role == "member"): ?>
																<li>
																	<a href="<?php echo lang_base_url(); ?>sell-now">
																		<i class="icon-shopping-basket"></i>&nbsp;<?php echo ("Add Product"); ?>
																	</a>
																</li>
															<?php else: ?>
																<li>
																	<a href="<?php echo lang_base_url(); ?>sell-now?bully=work">
																		<i class="icon-shopping-bag"></i>&nbsp;<?php echo ("Add Handwork"); ?>
																	</a>
																</li>
															<?php endif; ?>
														<?php endif; ?>

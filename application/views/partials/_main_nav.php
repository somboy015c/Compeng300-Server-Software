					...
					foreach ($parent_categories as $category):
						if ($count <= $limit):?>
							<li class="nav-item dropdown" data-category-id="<?php echo $category->id; ?>">
								...
								<a href="<?php echo generate_category_url($category); ?>" class="bn-lg nav-link dropdown-toggle" style="min-width: 0px; min-height: 0px; text-align: left; width: unset;">
									<?php echo html_escape(get_category_name_by_lang($category->id, $this->selected_lang->id)); ?>
								</a>
								<a href="<?php echo generate_category_url($category); ?>" class="bn-md nav-link dropdown-toggle" style="font-size: 12px; min-width: 0px; min-height: 0px; text-align: left; width: unset;margin-right: 0px;">
									<?php echo html_escape(get_category_name_by_lang($category->id, $this->selected_lang->id)); ?>
								</a>

...
<div class="row featured-categories">
    ...
    <div class="col">
        ...
        <?php endif; ?>
        <?php $f_cat_6 = get_featured_category(6); ?>
        <?php if (!empty($f_cat_6)): ?>
            <div class="featured-category featured-category-6">
                <div class="inner" style=" border-radius: 24px;">
                    <a href="<?php echo generate_category_url($f_cat_5); ?>">
                        <img src="<?php echo $img_bg_product_small; ?>" data-src="<?php echo get_category_image_url($f_cat_6, 'image_1'); ?>" alt="<?php echo html_escape($f_cat_6->name); ?>" class="lazyload img-fluid">
                        <div class="caption text-truncate">
                            <span><?php echo html_escape($f_cat_6->name); ?></span>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <div class="col">
        <?php $f_cat_7 = get_featured_category(7); ?>
        <?php if (!empty($f_cat_7)): ?>
            <div class="featured-category featured-category-7">
                <div class="inner" style=" border-radius: 24px;">
                    <a href="<?php echo generate_category_url($f_cat_7); ?>">
                        <img src="<?php echo $img_bg_product_small; ?>" data-src="<?php echo get_category_image_url($f_cat_7, 'image_1'); ?>" alt="<?php echo html_escape($f_cat_7->name); ?>" class="lazyload img-fluid">
                        <div class="caption text-truncate">
                            <span><?php echo html_escape($f_cat_7->name); ?></span>
                        </div>
                    </a>
                </div>
            </div>
        <?php endif; ?>
        <?php $f_cat_8 = get_featured_category(8); ?>
        <?php if (!empty($f_cat_8)): ?>
            <div class="featured-category featured-category-8">
                <div class="inner" style=" border-radius: 24px;">
                    <a href="<?php echo generate_category_url($f_cat_8); ?>">
                        <img src="<?php echo $img_bg_product_small; ?>" data-src="<?php echo get_category_image_url($f_cat_8, 'image_1'); ?>" alt="<?php echo html_escape($f_cat_8->name); ?>" class="lazyload img-fluid">
                        <div class="caption text-truncate">
                            <span><?php echo html_escape($f_cat_8->name); ?></span>
                        </div>
                    </a>
                </div>
            </div>

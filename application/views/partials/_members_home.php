                                ...
                                <div class="member-list-item" style="min-height: 138px;display: table;width: 100%;padding: 5px 5px 5px;box-sizing: border-box;color: #676b6d;font-size: 14px;line-height: 19px;border: 1px solid rgba(182, 180, 180, .25);background: #fff;color: #676b6d;transition: box-shadow 0.25s ease;margin-bottom: 18px;box-shadow: 0px 1px 5px 0px rgba(210, 200, 200, .5); border-radius: 6px;">
                                    ...
                                    <div class="row-custom pdp" style="padding-left: 10px; padding-right: 10px;">
                                        <div class="row-custom">
                                            ...
                                            <label class="btn btn-sm btn-profile-option pdd" style="border-radius: 3px; float: right; vertical-align: middle; background-color: <?php echo $this->general_settings->$color; ?>; color: white; font-weight: 600; padding-top: 2px; padding-bottom: 2px;">Shop</label>
                                        </div>
                                        ...
                                        <div class="row-custom">
                                            ...
                                            <p  style=" font-size: 13px;margin-bottom: 7px;margin-top: 5px;"><?php $num_len = strlen($shop_cat); if ($num_len > 26) {
                                            echo substr(html_escape($shop_cat), 0, 25) . "..";}else { echo html_escape($shop_cat); } ?></p>
                                        </div>
                                        <div class="row-custom" style="padding-bottom: 10px;">
                                            <div class="" style="float: left;">
                                               <label class="hbh" style="margin-bottom: 0px;color: <?php echo $this->general_settings->$color; ?>; font-size: 16px; font-weight: 600; line-height: 22px;"><?php if (strpos($member->shop_plan, 'holesaler') != false) { echo "Wholesaler"; } elseif (strpos($member->shop_plan, 'etailer') != false) { echo "Retailer"; } elseif (strpos($member->shop_plan, 'anufacturer') != false) { echo "Manufacturer"; }  ?></label>
                                            </div>
...
<?php else: ?>
                            ...
                            <a href="<?php echo lang_base_url(); ?>profile/<?php echo $member->slug; ?>">
                                <div class="member-list-item" style="min-height: 138px;display: table;width: 100%;padding: 5px 5px 5px;box-sizing: border-box;color: #676b6d;font-size: 14px;line-height: 19px;border: 1px solid rgba(182, 180, 180, .25);background: #fff;color: #676b6d;transition: box-shadow 0.25s ease;margin-bottom: 18px;box-shadow: 0px 1px 5px 0px rgba(210, 200, 200, .5); border-radius: 6px;">
                                    ...
                                    <div class="row-custom  pdp" style="padding-left: 10px; padding-right: 10px;">
                                        <div class="row-custom">
                                            <label class="fnt2" style="font-size: 18px; margin: 0px;"><p class="username" style=" margin: 0px;"><?php $num_len = strlen(get_shop_name($member)); if ($num_len > 12) {
                                            echo substr(get_shop_name($member), 0, 10) . "..";
                                            } else { echo get_shop_name($member);} ?>
                                                    <i class="icon-verified icon-verified-member mg" style="margin-left: 0px; float: none;"></i>
                                            </p></label>
                                            <label class="btn btn-sm btn-profile-option pdd2 ddd" style="border-radius: 3px; float: right; vertical-align: middle; background-color: <?php echo $this->general_settings->$color; ?>; color: white; font-weight: 600; padding-top: 2px; padding-bottom: 2px;">Workshop</label>
                                        </div>

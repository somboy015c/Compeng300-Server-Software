            ...
            <div class="col-12">
                <div class="page-confirm">
                    <?php if (!empty($success)): ?>
                        ...
                        <a href="javascript:void(0)" class="btn btn-md btn-custom m-t-15" data-toggle="modal" data-target="#loginModal" class="pad" style="border-radius: 6px;"><?php echo trans("login"); ?></a>

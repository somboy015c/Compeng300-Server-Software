...
<?php if (user()->role == "member" || (user()->role != "member" && user()->shop_due == 1) || (user()->role != "member" && !empty($pt))): ?>
                                                                        ...
                                                                        <div class="row">
                                                                                <div class="col-12 col-sm-6 col-option">
                                                                                    <div class="custom-control custom-radio">
                                                                                        <input type="radio" name="product_type" value="digital" id="product_type_2" class="custom-control-input" checked required>
                                                        ...
                                                        <div class="form-box">
                                                            ...
                                                            <div class="form-box-body">
                                                                ...
                                                                <div class="form-group" style="display:none;">
                                                                    ...
                                                                    <div class="selectdiv">
                                                                        <select id="categories" name="category_id_0" class="form-control" required>
                                                                            <option value="<?php echo ($user->shop_category_id); ?>"><?php echo get_category_name_by_lang($user->shop_category_id, $this->selected_lang->id); ?></option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                            ...
                                            <?php else: ?>
                                                <div class="form-box">
                                                    <div class="text-center">
                                                        <div class="form-box-head">
                                                            <h4 class="title" style="color: #9fafc0;"><?php echo ('Out Of Space'); ?></h4>
                                                        </div>
                                                        <p class="dm-upload-icon">
                                                            <i class="icon-upload"><?php echo ('!'); ?></i>
                                                        </p>
                                                        <p class="dm-upload-text"><?php echo ('You are out of storage space, free up some space and try again, or'); ?>&nbsp;<span style="text-decoration: underline; color: red;"><?php echo ('Buy More Space'); ?></span></p>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                            </div>
						...
						<div class="col-12 col-md-12 col-lg-11">
							...
							<div class="row">
								<div class="col-12">
									...
									<div class="form-group">
                                    <input type="hidden" name="qty_scale" value="<?php echo 1; ?>">
                                    <input type="hidden" name="forsale" value="<?php echo 1; ?>">
									<button type="submit" class="btn btn-lg btn-custom float-right"><?php echo trans("save_and_continue"); ?></button>
									</div>
...
<!-- Wrapper End-->
<?php endif; ?>
<?php elseif (user()->role != "member" && user()->shop_due != 1 && empty($pt)): ?>
						...
						<div class="col-12 col-md-12 col-lg-11">
							...
							<div class="row">
								<div class="col-12">
											...
											<div class="form-box-body">
												<div class="form-group">
													<div class="row">
														...
														<?php endif; ?>
														<?php if ($general_settings->digital_products_system == 1 && user()->role != "member" && $user->shop_category_id == 31): ?>
															<div class="col-12 col-sm-6 col-option">
																<div class="custom-control custom-radio">
											...
											<div class="form-box-body">
												<div class="form-group">
													<div class="row">
														...
														<?php endif; ?>
														<?php if ($general_settings->classified_ads_system == 1 && user()->role != "member"): ?>
															<div class="col-12 col-sm-6 col-option listing_ordinary_listing">
																<div class="custom-control custom-radio">
									...
									<div class="form-box">
										...
										<div class="form-box-body">
											...
											<div class="form-group">
                                                ...
                                                <div class="selectdiv">
                                                    <select id="categories" name="category_id_0" class="form-control" required>
                                                        <option value="<?php echo html_escape($user->shop_category_id); ?>"><?php echo html_escape(get_category_name_by_lang($user->shop_category_id, $this->selected_lang->id)); ?></option>
                                                    </select>
                                                </div>
                                    ...
                                    <?php if (strpos($user->shop_plan, 'holesaler') != false) { $qty = ' (Bulk)'; } elseif (strpos($user->shop_plan, 'anufacturer') != false) { $qty = ' (Company Sales)'; } elseif (strpos($user->shop_plan, 'etailer') != false) { $qty = ' (Pieces)'; } ?>
                                    <input type="hidden" name="qty_scale" value="<?php echo $qty; ?>">
                                    <input type="hidden" name="forsale" value="<?php echo 0; ?>">

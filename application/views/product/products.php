				...
				<div class="col-12 product-list-header">
					...
					<div class="product-sort-by">
						<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>
							<span class="span-sort-by"><?php echo ("Product Type: "); ?></span>
							<button type="submit" name="type" value="all" class="btn btn-md <?php if ($type != 'all' && !empty($type)) {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>" style="margin-left: 5px; border-radius: 6px; padding: 3px 10px 3px 10px;">All Products</button>
							<button type="submit" name="type" value="Store Products" class="btn btn-md <?php if ($type != 'Store Products') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>" style="margin-left: 5px; border-radius: 6px; padding: 3px 10px 3px 10px;">Store Products</button>
							<button type="submit" name="type" value="Products For Sale" class="btn btn-md <?php if ($type != 'Products For Sale') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>" style="margin-left: 5px; margin-right: 20px; border-radius: 6px; padding: 3px 10px 3px 10px;">Products For Sale</button>
						<?php endif; ?>
			...
			<div class="row">
				<div class="col-12 product-list-header">
					...
					<div class="span-sort-by product-sort-by">
						<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>							<button type="submit" name="type" value="all" class="btn btn-md <?php if ($type != 'all' && !empty($type)) {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>" style="margin-left: 5px; border-radius: 6px; padding: 3px 10px 3px 10px;">All Products</button>
							<button type="submit" name="type" value="Store Products" class="btn btn-md <?php if ($type != 'Store Products') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>" style="margin-left: 5px; border-radius: 6px; padding: 3px 10px 3px 10px;">Store Products</button>
							<button type="submit" name="type" value="Products For Sale" class="btn btn-md <?php if ($type != 'Products For Sale') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>" style="margin-left: 5px; margin-right: 20px; border-radius: 6px; padding: 3px 10px 3px 10px;">Products For Sale</button>
						<?php endif; ?>
						<div class="dropdown sort-select">
											...
											<div class="row-custom"style="padding: 0px; margin: 0px;">
											    ...
											    <!--print blog slider posts-->
													...
													<li class="nav-item">
						                             	<div class="product-sort-by">
															<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>
																<button type="submit" name="type" value="all" class="btn btn-md <?php if ($type != 'all' && !empty($type)) {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>"  style="border-radius: 6px; margin-left: 5px;"><?php echo "All&nbsp;Products"; ?></button>
															<?php endif; ?>
														</div>
													</li>
													<li class="nav-item">
						                             	<div class="product-sort-by">
															<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>
																<button type="submit" name="type" value="Store Products" class="btn btn-md <?php if ($type != 'Store Products') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>"  style="border-radius: 6px;margin-right: 5px;"><?php echo "Store&nbsp;Products"; ?></button>
															<?php endif; ?>
														</div>
													</li>
													<li class="nav-item">
														<div class="product-sort-by">
															<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>
																<button type="submit" name="type" value="Products For Sale" class="btn btn-md <?php if ($type != 'Products For Sale') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>"  style="border-radius: 6px;margin-left: 7px;"><?php echo "Products&nbsp;For&nbsp;Sale"; ?></button>
															<?php endif; ?>
														</div>
													</li>
													<p></p>
									...
									<div class="row-custom"style="padding: 0px; margin: 0px;">
									    ...
									    <!--print blog slider posts-->
													...
													<li class="nav-item">
						                             	<div class="product-sort-by">
															<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>
																<button type="submit" name="type" value="all" class="btn btn-md <?php if ($type != 'all' && !empty($type)) {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>"  style="border-radius: 6px; font-size: 11px; padding: 5px; margin-left: 5px;"><?php echo "All&nbsp;Products"; ?></button>
															<?php endif; ?>
														</div>
													</li>
													<li class="nav-item">
						                             	<div class="product-sort-by">
															<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>
																<button type="submit" name="type" value="Store Products" class="btn btn-md <?php if ($type != 'Store Products') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>"  style="border-radius: 6px; font-size: 11px; padding: 5px; margin-right: 5px;"><?php echo "Store&nbsp;Products"; ?></button>
															<?php endif; ?>
														</div>
													</li>
													<li class="nav-item">
														<div class="product-sort-by">
															<?php if ((empty($category) && $search_type != 'Handwork') || (!empty($category) && ($category->name != 'Services' && $category->parent_id != 12))): ?>
																<button type="submit" name="type" value="Products For Sale" class="btn btn-md <?php if ($type != 'Products For Sale') {echo 'btn-outline-gray';} else{echo 'btn-custom';} ?>"  style="border-radius: 6px; font-size: 11px; padding: 5px; margin-left: 7px;"><?php echo "Products&nbsp;For&nbsp;Sale"; ?></button>
															<?php endif; ?>
														</div>
													</li>
													<p></p>
					...
					if (!empty($filters)):
						foreach ($filters as $key => $value):
							if (!empty($value) && $key != 'sort' && $key != 'condition' && $key != 'country' && $key != 'state' && $key != 'city' && $key != 'p_min' && $key != 'p_max' && $key != 'page'
							 && $value != 'promoted_products' && $value != 'product_for_sales' && $value != 'top_products' && $value != 'trending_products' && $value != 'latest_products' && $value != 'promoted_works' && $value != 'top_works' && $value != 'trending_works' && $value != 'latest_works'):?>
					...
					<div class="row row-product">
							...
							<?php if (empty($products)): ?>
								<div class="col-12">
									...
									<?php else: ?>
										<p class="no-records-found"><?php echo ("No Handworks found!"); ?></p>
									<?php endif; ?>
								</div>
							<?php endif; ?>
						</div>

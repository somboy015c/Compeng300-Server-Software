		...
		<div class="row">
			<div id="content" class="col-12">
				...
				<?php if ($product->is_draft == 1): ?>
					<h1 class="page-title page-title-product"><?php echo ("Upload Work"); ?></h1>
				<?php else: ?>
					<h1 class="page-title page-title-product"><?php echo ("Edit Work"); ?></h1>
				<?php endif; ?>
						...
						<div class="col-12 col-md-12 col-lg-11">
							...
							<div class="row">
								<div class="col-12">
									...
									<?php if (strpos($user->workshop_plan, 'asic') == false ): ?>
									<div class="form-box">
										<div class="form-box-head">
											<h4 class="title"><?php echo ('Additions (Optional)'); ?></h4>
										</div>
										<div class="form-box-body">
											<div class="form-group">
												<div class="row">
													<?php if (strpos($user->workshop_plan, 'ltimate') != false ): ?>
													<div class="col-12 col-sm-6 col-option">
														<div class="custom-control custom-radio">
															<input type="radio" name="addition_type" value="music" id="addition_type_1" class="custom-control-input"<?php if (strpos($user->workshop_plan, 'ltimate') != false ){echo "checked";} ?> required>
															<label for="addition_type_1" class="custom-control-label"><?php echo ('Demo Music'); ?></label>
															<p class="form-element-exp"><?php echo ('Include demo music file related to your work'); ?></p>
														</div>
													</div>
													<?php endif; ?>
													<div class="col-12 col-sm-6 col-option">
														<div class="custom-control custom-radio">
															<input type="radio" name="addition_type" value="video" id="addition_type_2" class="custom-control-input"<?php if (strpos($user->workshop_plan, 'remium') != false ){echo "checked";} ?> required>
															<label for="addition_type_2" class="custom-control-label"><?php echo ('Demo Video'); ?></label>
															<p class="form-element-exp"><?php echo ('Include demo video file related to your work'); ?></p>
														</div>
													</div>
												</div>
											</div>
									...
									<input type="hidden" name="country_id" value="<?php echo user()->country_id; ?>">
									<input type="hidden" name="state_id" value="<?php echo user()->state_id; ?>">
									<input type="hidden" name="city_id" value="<?php echo user()->city_id; ?>">
									...
									<div class="row-custom">
										<div class="row">
											<?php if (strpos($user->workshop_plan, 'ltimate') != false ): ?>
											<div class="col-12 col-sm-12 m-b-30" id="pp">
												<label class="control-label font-600"><?php echo ("Upload Audio"); ?></label>
												<small>(<?php echo trans("audio_preview_exp"); ?>)</small>
												<?php $this->load->view("product/_audio_upload_box", ['audio' => $audio]); ?>
											</div>
											<?php endif; ?>
											<div class="col-12 col-sm-12 m-b-30" id="qq">
												<label class="control-label font-600"><?php echo ("Upload Video"); ?></label>
									...
									<?php if ($product->listing_type == 'ordinary_listing'): ?>
										<?php if ($form_settings->external_link == 1): ?>
											<div class="form-box">
												<div class="form-box-head">
													<h4 class="title"><?php echo ('External Link (Optional)'); ?></h4>
									...
									<div class="form-group m-t-15">
										<?php if ($product->is_draft == 1): ?>
											<a href="<?php echo lang_base_url(); ?>sell-now/<?php echo $product->id; ?>?bully=work" class="btn btn-lg btn-custom float-left"><?php echo trans("back"); ?></a>
										...
										<?php else: ?>
											<a href="<?php echo lang_base_url(); ?>sell-now/edit-product/<?php echo $product->id; ?>?bully=work" id="btn_tab_product_images" class="btn btn-lg btn-custom float-left"><?php echo trans("back"); ?></a>
	...
	<div class="container">
		<div class="row">
			<div id="content" class="col-12">
				...
				<?php if ($product->is_draft == 1): ?>
					<h1 class="page-title page-title-product"><?php if ($product->for_sale == 1) { echo trans("sell_now"); }else{ echo ("Post product"); }?></h1>
				<?php else: ?>
						...
						<div class="col-12 col-md-12 col-lg-11">
							...
							<div class="row">
								<div class="col-12">
												...
												<?php if ($product->product_type == 'physical'): ?>
													<div class="form-group">
														<div class="row">
															...
															<?php if ($form_settings->quantity == 1 && $product->for_sale != 1) : ?>
																<div class="col-12 col-sm-6">
																	<label class="control-label"><?php echo trans('quantity') . $product->qty_scale; ?></label>
																...
																<?php if ($product->qty_scale == ' (Bulk)'): ?>
																<div class="col-12 col-sm-6" style="padding-top: 20px;">
											 						<div class="form-box-head" style="padding-left: 0px;">
																		<h4 class="title"><?php echo trans('quantity') . ' In a Bulk'; ?></h4>
																		<small><?php echo ("Number of pieces of product in a bulk"); ?></small>
																	</div>
																	<input type="number" name="bulk_quantity" class="form-control form-input" min="1" max="999999" value="<?php echo html_escape($product->bulk_quantity); ?>" placeholder="<?php echo trans("quantity"); ?>" <?php echo ($form_settings->quantity_required == 1) ? 'required' : ''; ?>>
																</div>
																<?php else: ?>
																	<input type="hidden" name="bulk_quantity"value="1">
																<?php endif; ?>
															<?php endif; ?>
														</div>
													</div>
									...
									<?php if ((($product->product_type == 'physical' && $form_settings->physical_demo_url == 1) || ($product->product_type == 'digital' && $form_settings->digital_demo_url == 1)) && $product->for_sale != 1): ?>
										<div class="form-box">
											<div class="form-box-head">

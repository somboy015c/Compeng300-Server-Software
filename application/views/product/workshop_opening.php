	        ...
	        <div class="col-md-8 col-sm-12 col-md-offset-2">
	            <div class="row">
	                <div class="col-sm-12 logo-cnt">
	                   <h1 class="page-title page-title-product m-b-15"><?php echo ("Open a Workshop"); ?></h1>
	                   <p style="font-size: 15px;"><?php echo ("In order to own a workshop, you must be a verified member. fill in the bellow form carefully and wait for admin aproval."); ?></p>
	                </div>
	            </div>
	            <div class="row">
	                <div class="col-sm-12">
	                    <div class="install-box">
	                        <div class="steps">
	                            ...
	                            <div class="step active">
	                                ...
	                                <p><?php echo ("Workshop Opening"); ?></p>
	                            </div>
	                        </div>

	                        <div class="step-contents">
	                            <div class="tab-1">
	                                <h1 class="step-title"><?php echo ("Workshop Opening Request"); ?></h1>
	                                <div class="row">
				                        <div class="row">
											<div class="col-12">
											...
											<?php elseif ($this->auth_user->is_active_workshop_request != 1 && $this->auth_user->is_active_workshop_request != 2 && $this->auth_user->is_active_shop_request != 1): ?>
												<div class="row">
													<div class="col-12">
														...
														<center><b><h6 style="font-size: 15px; padding-bottom: 5px;"><?php echo ('Tell Us About Your Workshop'); ?></h6></b></center>
																		...
																		<div class="col-12 col-sm-4 m-b-15">
																			...
																			<div class="selectdiv">
																				<select id="states" name="state_id" class="form-control" onchange="get_cities(this.value);" required>
																					<option value=""><?php echo ('selectSelect your bussiness State'); ?></option>
																					<?php
																					if (!empty($states)):

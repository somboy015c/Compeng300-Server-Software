                                    ...
                                    <div class="form-add-product">
                                        <div class="row justify-content-center">
                                            <div class="col-12 col-md-12 col-lg-11">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <?php echo form_open('product_controller/edit_product_post', ['id' => 'form_validate', 'onkeypress' => "return event.keyCode != 13;"]); ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <?php else: ?>
                                                                <a href="<?php echo lang_base_url(); ?>sell-now/product-details/<?php echo $product->id; ?>?bully=work" class="btn btn-lg btn-custom float-right"><?php echo trans("edit_details"); ?></a>
